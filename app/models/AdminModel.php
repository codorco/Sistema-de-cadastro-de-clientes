...
class AdminModel extends BaseModel
{
    ...
    public function get_global_stats()
    {
        ...
        // Total de clientes inativos (excluídos)
...
// =======================================================
    ...
    {
        // Obtém dados do agente a serem editados.
        $params = [
            ':id' => $id
        ];
    ...
    {
        // Verifica se há outro agente com o mesmo nome (e-mail).
        $params = [
            ':id' => $id,
            ':name' => $name
        ];
   ...
   // =======================================================
    ...
    {
        // Retorna os dados pessoais do agente e total de clientes.
        $params = [
            ':id' => $id
        ];
        $this->db_connect();
    ...
    {
        // Retorna informações completas sobre os agentes.
        $this->db_connect();
        $results = $this->query(
            "SELECT " .
